...
forex-scrapper --source crypto --format table

echo -e "\n3. Fetching Energy Exch events for a specific date (2026-05-20) in table format:"
forex-scrapper --source energy --date 2026-05-20 --format table

echo -e "\n4. Fetching Metals Mine events for today in table format:"
